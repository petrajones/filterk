...
# times contains three rows for filterK, IF and LOF and two columns
# for training and test sets
times = np.zeros((3, 2))
# silhouette_score contains four rows for original clustering, filterK, IF and
# LOF and two columns for training and test sets
silhouette_score = np.zeros((4, 2))
